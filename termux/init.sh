...
gcc \\
    ...
    -fdwarf2-cfi-asm -fplt -fjump-table -ftrivial-auto-var-init=uninitialized -fno-conserve-stack -fomit-frame-pointer -fstrict-aliasing -fdelete-null-pointer-checks -ffinite-loops -foptimize-sibling-calls -ffast-math -ffp-contract=fast -fallow-store-data-races \\
