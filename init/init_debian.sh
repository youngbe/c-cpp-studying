...
# 内核编译
apt --no-install-recommends -y install "clang${llvm_version}" "lld${llvm_version}" "llvm${llvm_version}" make bc flex bison python3-minimal libelf-dev libssl-dev libncurses-dev dwarves
